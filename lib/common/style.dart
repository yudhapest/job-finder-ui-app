...
class ColorManager {
  static Color primaryColor = HexColor.fromHex('#FFFFFF');
  static Color greyColor = HexColor.fromHex('#9CA5B4');
  static Color blackColor = HexColor.fromHex('#081d43');
  static Color blueColor = HexColor.fromHex('#5078E1');
  static Color greenColor = HexColor.fromHex('#0A5C36');
  static Color darkBlueColor = HexColor.fromHex('#03254C');
  static Color lightGreyColor = HexColor.fromHex('#EAE1DF');
  static Color backgroundColor = HexColor.fromHex('#F6F8FB');
}
...
TextStyle getDarkTextStyle({
  double fontSize = FontSizeManager.f22,
...
TextStyle getGreyTextStyle({
  double fontSize = FontSizeManager.f12,
  FontWeight fontWeight = FontWeightManager.regular,
}) {
  return _getTextStyle(
    fontSize,
